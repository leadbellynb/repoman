...
print('The NHIS_2007_RData file is the smallest.')
print('The .CSv and .txt are in human readable form. The .RData is in a binary format, which makes it much smaller.')
#3
